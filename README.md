...
|이름|담당|역할|
|------|-----|--------|
|김재현|프론트엔드|MZ어 타자연습, 단어장, 사이드바, 게시판, 관리자 승인 페이지|
|손호성|프론트엔드|키오스크 페이지, footer|
...
## API Address
![image](https://github.com/JHSasdf/project_2_hypeboy/assets/146299597/6762278d-bfb6-425c-8dd4-55c216064c1e)
